...
function seedInitialData() {
  ...
  if (u.getLastRow() <= 1) {
    const seed = [
      ['u1', 'soshin',    '안양대',   '미디어콘텐츠학과',   '아리학종',         '확인필요', '서류70+면접30', '6등급대 합격 사례 있음. 진로 일관성 강점', '준비중', '4년제'],
      ['u2', 'jeokjeong', '한신대',   '미디어영상광고학과', '학종',             '확인필요', '서류70+면접30', '경기 오산. 6등급대 합격 다수', '준비중', '4년제'],
      ['u3', 'jeokjeong', '강남대',   '미디어커뮤니케이션', '지역균형/학종',     '확인필요', '일부 면접',     '경기 용인. 4년제 중 가장 안정적', '준비중', '4년제'],
      ['u4', 'anjun',     '인덕대',   '방송영상미디어학과', '일반전형',         '없음',     '면접 있음',     '서울 노원. 편입 실적 우수', '준비중', '전문대'],
      ['u5', 'anjun',     '신구대',   '미디어콘텐츠과',     '일반전형',         '없음',     '면접 있음',     '경기 성남. 남양주 통학 가능', '준비중', '전문대'],
      ['u6', 'anjun',     '명지전문대','미디어영상',         '일반전형',         '없음',     '면접 있음',     '서울 서대문. 안전판 추가', '준비중', '전문대']
    ];
