...
const UNIV_SEED_2027 = [
  ...
  ['u4', 'jeokjeong', '서경대학교', '공연예술학부 연출전공', '실기우수자(정원내, 모집10명)', '없음', '학생부(교과)60%+실기40% — 공연콘텐츠 계획안 작성(60분,1000~1500자)+질의응답', '서울 성북구 정릉동(서경로124). 남양주→약1~1.5시간 추정(정확 경로 확인 필요). 실기고사 예약 2026.10.22~10.25. 소재(공간·문장·상황·오브제 등) 제시 → 주제·시놉시스·연출의도·연출안 포함 계획안 작성 → 지원동기·학습계획 질의응답', '신규분석', '4년제'],
